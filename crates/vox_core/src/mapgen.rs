...
pub fn generate_map(seed: u64, size: f32, density: f32) -> Vec<GaussianSplat> {
    ...
    let grass_spd = spd_to_u16([
        0.03, 0.03, 0.04, 0.04, 0.05, 0.06, 0.10, 0.38, 0.36, 0.22, 0.14, 0.08, 0.06, 0.42, 0.46,
        0.48,
    ]);
    let rock_spd = spd_to_u16([
        0.12, 0.13, 0.15, 0.17, 0.18, 0.18, 0.17, 0.16, 0.16, 0.15, 0.15, 0.15, 0.14, 0.14, 0.14,
        0.13,
    ]);
    let water_spd = spd_to_u16([
        0.02, 0.03, 0.05, 0.08, 0.10, 0.09, 0.07, 0.05, 0.04, 0.03, 0.02, 0.01, 0.01, 0.01, 0.01,
        0.01,
    ]);
    let sand_spd = spd_to_u16([
        0.18, 0.20, 0.22, 0.25, 0.28, 0.30, 0.32, 0.35, 0.38, 0.40, 0.42, 0.43, 0.44, 0.45, 0.46,
        0.47,
    ]);
