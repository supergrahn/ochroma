...
impl BiomeAmbientMix {
    pub fn for_biome(biome: BiomeKind) -> Self {
        match biome {
            ...
            BiomeKind::Tundra => Self {
                wind: 0.9,
                water: 0.1,
                insects: 0.0,
                ice: 0.7,
            },
            BiomeKind::Forest => Self {
                wind: 0.2,
                water: 0.1,
                insects: 0.7,
                ice: 0.0,
            },
            BiomeKind::Grassland => Self {
                wind: 0.4,
                water: 0.0,
                insects: 0.5,
                ice: 0.0,
            ...
            BiomeKind::Wetland => Self {
                wind: 0.1,
                water: 0.6,
                insects: 0.9,
                ice: 0.0,
            },
            BiomeKind::Coastal => Self {
                wind: 0.5,
                water: 0.8,
                insects: 0.1,
                ice: 0.0,
            },
            BiomeKind::SubalpineShrub => Self {
                wind: 0.6,
                water: 0.1,
                insects: 0.2,
                ice: 0.2,
            },
            BiomeKind::Savanna => Self {
                wind: 0.5,
                water: 0.0,
                insects: 0.6,
                ice: 0.0,
            },
            BiomeKind::Taiga => Self {
                wind: 0.3,
                water: 0.1,
                insects: 0.4,
                ice: 0.1,
            },
            BiomeKind::TropicalRainforest => Self {
                wind: 0.1,
                water: 0.3,
                insects: 1.0,
                ice: 0.0,
...
mod tests {
    ...
    fn blend_converges() {
        ...
        assert!(
            (blended.insects - b.insects).abs() < 1e-5,
            "full blend should equal target"
        );
    }
    ...
    fn quiet_biome_mixes_quieter_than_loud_biome() {
        ...
        assert!(
            loud.total_weight() > quiet.total_weight(),
            "loud total_weight {} must exceed quiet {}",
            loud.total_weight(),
            quiet.total_weight()
        );
    }
