...
|---|---|---|---|
| `TierThresholds` + `select_hybrid` | per frame before render | `urban_horizon/src/render_gpu/mod.rs` `render_instanced`; `scale_trial --hybrid` | one classify branch; T1/T2 walk unchanged |
