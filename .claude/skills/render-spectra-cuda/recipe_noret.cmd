...
set OCHROMA_PRESENT_SHOT=C:\Users\tom_e\dlss-shots\recipe_noret.png
target\release\play.exe > C:\Users\tom_e\recipe_noret.log 2>&1
echo NORET_EXIT=%errorlevel%
echo NORET_DONE
