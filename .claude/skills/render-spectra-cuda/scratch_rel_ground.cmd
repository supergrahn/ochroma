...
set OCHROMA_HERO_DIST=140
set OCHROMA_HERO_PITCH=0.10
set OCHROMA_HERO_HOUR=13.0
set OCHROMA_PRESENT_BENCH_DISPLAY=3840x2160
set OCHROMA_PRESENT_SHOT=C:\Users\tom_e\dlss-shots\map30_rel_ground.png
set OCHROMA_PRESENT_BENCH_FRAMES=20
set OCHROMA_PRESENT_BENCH_WARMUP=5
target\release\play.exe > C:\Users\tom_e\map30_rel_ground.log 2>&1
